...
export const getGetStoreOrderUrl = (slug: string,
    orderId: number,
  ...
  return stringifiedParams.length > 0 ? `/api/stores/${slug}/orders/${orderId}?${stringifiedParams}` : `/api/stores/${slug}/orders/${orderId}`
}
 ...
 */
export const getStoreOrder = async (slug: string,
    orderId: number,
    params: GetStoreOrderParams, options?: Parameters<typeof customFetch>[1]): Promise<TrackOrderResponse> => {

  return customFetch<TrackOrderResponse>(getGetStoreOrderUrl(slug,orderId,params),
  {
    ...options,
    method: 'GET'
...
export const getGetStoreOrderQueryKey = (slug: string,
    orderId: number,
    params?: GetStoreOrderParams,) => {
    return [
    `/api/stores/${slug}/orders/${orderId}`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetStoreOrderQueryOptions = <TData = Awaited<ReturnType<typeof getStoreOrder>>, TError = ErrorType<ErrorResponse>>(slug: string,
    orderId: number,
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetStoreOrderQueryKey(slug,orderId,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getStoreOrder>>> = ({ signal }) => getStoreOrder(slug,orderId,params, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: slug !== null && slug !== undefined && orderId !== null && orderId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getStoreOrder>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetStoreOrder<TData = Awaited<ReturnType<typeof getStoreOrder>>, TError = ErrorType<ErrorResponse>>(
 slug: string,
  ...
  const queryOptions = getGetStoreOrderQueryOptions(slug,orderId,params,options)
